...
## 
key_set_with_value("thlb_proxy", password = "postgres", keyring = "localpsql")
...
## note: if bad_alloc happens - run at the end of the day & close all other applications - very RAM intensive script
