...
)
{
	...
	## TODO - is the integrated road file good enough to replace the following?
	...
	lyr_1_tbl <- "whse_sp.GBA_RAILWAY_TRACKS_SP"
	lyr_1_buf <- "15"

	lyr_2_tbl <- "whse_sp.GBA_TRANSMISSION_LINES_SP"
	lyr_2_buf <- "25"

	lyr_3_tbl <- "whse_sp.DRP_OIL_GAS_PIPELINES_BC_SP"
	lyr_3_buf <- "15"

	lyr_4_tbl <- "whse_sp.OG_PIPELINE_AREA_PERMIT_SP"
	lyr_4_buf <- "15"

	lyr_5_tbl <- "whse_sp.integratedroadsbuffers"
	...
	lyr_6_tbl <- "whse_sp.ta_crown_rights_of_way_svw"
	## no buffer as it is a polygon layer
