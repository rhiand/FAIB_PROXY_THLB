...
FROM whse.thlb_proxy_netdown p where man_unit = 'Merritt TSA'"
...
conn_list <- dadmtools::get_pg_conn_list()
my_table <- sql_to_df('SELECT src_type, src_path, src_lyr, dst_schema, dst_tbl, query, created_at FROM whse.data_sources', conn_list)
